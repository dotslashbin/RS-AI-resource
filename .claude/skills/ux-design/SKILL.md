---
name: ux-design
description: Use before making any visual or interaction change in vendor/booker/command — checklist for user-job framing, visual hierarchy, state handling (loading/empty/error/populated), accessibility, and light/dark theming.
---
